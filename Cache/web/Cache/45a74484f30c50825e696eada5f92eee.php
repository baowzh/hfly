...
<body>
  ...
  <div class="navs">
    <div class="nav">
        ...
        <?php if(is_array($navlist)): $i = 0; $__LIST__ = $navlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 3 );++$i;?><li><a href="<?php echo U('viewpoint/index',array('id'=>$vs['id']));?>"><?php echo ($vs["names"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
  </div>
...
<div class="main_lines">
   ...
   <div class="mianconent">
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 3 );++$i;?><li <?php if($mod == 2 ): ?>class="lasts"<?php endif; ?>>
          <a href="<?php echo U('viewpoint/detail',array('id'=>$vo['id']));?>" target="_blank"><img alt="<?php echo ($vo["names"]); ?>" width="376" height="247" src="<?php echo (get_line_img($vo["id"])); ?>" ></a>
          <div class="desc"><span class="adds"><a href="<?php echo U('viewpoint/detail',array('id'=>$vo['id']));?>"><?php echo ($vo["names"]); ?></a></span></div>
